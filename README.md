...
* If the picture is a good size then proceed to "Ready to insert the picture".

* If the picture is not a good size, use a graphics editor to resize it. Any graphics editor will do if you have one already.

## Editing the picture using GIMP
...
* Select the setting for "Choose default signature:", "New Messages" and/or "Replies/forwards".
* Click OK to save the signature and settings.
